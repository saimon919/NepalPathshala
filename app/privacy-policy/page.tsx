...
export const metadata: Metadata = {
  ...
  description: "Privacy Policy for NepalPathshala. Learn how we collect, use, and protect your data.",
};
    ...
    <>
      ...
      <section className="section">
        <div className="container article-wrap article-body">
          <p>
            At NepalPathshala, accessible from https://nepalpathshala.com, one of our main priorities is the privacy of our visitors. 
            This Privacy Policy document contains types of information that is collected and recorded by NepalPathshala and how we use it.
          </p>

          <h2>Log Files</h2>
          <p>
            NepalPathshala follows a standard procedure of using log files. These files log visitors when they visit websites. 
          ...
          <p>
            Like any other website, NepalPathshala uses "cookies". These cookies are used to store information including visitors' preferences, 
          ...
          <p>
            ...
            by visiting the Google ad and content network Privacy Policy at the following URL – https://policies.google.com/technologies/ads
          </p>
          ...
          <p>
            ...
            advertisements and links that appear on NepalPathshala, which are sent directly to users' browser. They automatically receive your 
          ...
          <p>Note that NepalPathshala has no access to or control over these cookies that are used by third-party advertisers.</p>
